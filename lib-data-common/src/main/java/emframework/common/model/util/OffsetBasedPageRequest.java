package emframework.common.model.util;
...
public class OffsetBasedPageRequest implements Pageable, Serializable {
    ...
    public OffsetBasedPageRequest(Integer offset, Integer limit, Sort sort) {
    	...
    	if (limit==null) limit = 50;//we return 50 items maximum //Integer.MAX_VALUE;
    	if (offset < 0) {
     ...
     */
    public OffsetBasedPageRequest(Integer offset, Integer limit, Sort.Direction direction, String... properties) {
